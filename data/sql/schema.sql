...
CREATE TABLE email (domain VARCHAR(64), PRIMARY KEY(domain)) ENGINE = INNODB;
...
CREATE TABLE skill_sets (id INT AUTO_INCREMENT, skill VARCHAR(120) NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
