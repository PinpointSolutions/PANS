...
CREATE TABLE project_allocations (project_id INT, snum1 INT, snum2 INT, snum3 INT, snum4 INT, snum5 INT, snum6 INT, INDEX snum1_idx (snum1), INDEX snum2_idx (snum2), INDEX snum3_idx (snum3), INDEX snum4_idx (snum4), INDEX snum5_idx (snum5), INDEX snum6_idx (snum6), PRIMARY KEY(project_id)) ENGINE = INNODB;
CREATE TABLE projects (id INT AUTO_INCREMENT, title VARCHAR(64), organisation VARCHAR(64), description TEXT, has_additional_info TINYINT(1), major_ids VARCHAR(64), skill_set_ids VARCHAR(64), nomination_round VARCHAR(64) NOT NULL, proj_num INT NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
