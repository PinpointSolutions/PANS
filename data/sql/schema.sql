...
CREATE TABLE project_allocations (project_id INT AUTO_INCREMENT, snum1 INT, snum2 INT, snum3 INT, snum4 INT, snum5 INT, snum6 INT, INDEX snum1_idx (snum1), INDEX snum2_idx (snum2), INDEX snum3_idx (snum3), INDEX snum4_idx (snum4), INDEX snum5_idx (snum5), INDEX snum6_idx (snum6), PRIMARY KEY(project_id)) ENGINE = INNODB;
CREATE TABLE projects (id INT AUTO_INCREMENT, title VARCHAR(64), organisation VARCHAR(64), description TEXT, has_additional_info TINYINT, major_ids VARCHAR(64), skill_set_ids VARCHAR(64), nomination_round VARCHAR(64) NOT NULL, proj_num INT NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE student_prefs (snum INT, nomination_round VARCHAR(64), pass_fail_pm TINYINT(1) NOT NULL, major_ids VARCHAR(32), gpa FLOAT(18, 2) DEFAULT 5.0, proj_pref_1 INT, proj_pref_2 INT, proj_pref_3 INT, proj_pref_4 INT, proj_pref_5 INT, skill_set_ids VARCHAR(32), y_stu_pref_1 INT, y_stu_pref_2 INT, y_stu_pref_3 INT, y_stu_pref_4 INT, y_stu_pref_5 INT, n_stu_pref_1 INT, n_stu_pref_2 INT, n_stu_pref_3 INT, n_stu_pref_4 INT, n_stu_pref_5 INT, proj_just_1 TEXT, proj_just_2 TEXT, proj_just_3 TEXT, proj_just_4 TEXT, proj_just_5 TEXT, INDEX proj_pref_2_idx (proj_pref_2), PRIMARY KEY(snum, nomination_round)) ENGINE = INNODB;
...
ALTER TABLE student_prefs ADD CONSTRAINT student_prefs_proj_pref_2_projects_id FOREIGN KEY (proj_pref_2) REFERENCES projects(id) ON DELETE CASCADE;
