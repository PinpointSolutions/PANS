...
abstract class BaseProjectsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'has_additional_info' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'has_additional_info' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
