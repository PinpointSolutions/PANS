...
abstract class BaseStudentPrefsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'proj_just_1'      => new sfValidatorString(array('required' => false)),
      'proj_just_2'      => new sfValidatorString(array('required' => false)),
      'proj_just_3'      => new sfValidatorString(array('required' => false)),
      'proj_just_4'      => new sfValidatorString(array('required' => false)),
      'proj_just_5'      => new sfValidatorString(array('required' => false)),
    ));
