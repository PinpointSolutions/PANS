...
abstract class BaseProjectAllocationsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'snum1'      => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('StudentUsers_3'), 'required' => false)),
      'snum2'      => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('StudentUsers_4'), 'required' => false)),
      'snum3'      => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('StudentUsers_5'), 'required' => false)),
      'snum4'      => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('StudentUsers_6'), 'required' => false)),
      'snum5'      => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('StudentUsers_7'), 'required' => false)),
      'snum6'      => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('StudentUsers'), 'required' => false)),
    ));
